...
Valide a AP.04 contra o estado atual do repositório.
Se o Definition of Done estiver atendido, marque somente a AP.04 como concluída.
Ajuste o README apenas se necessário.
Execute as validações.
Não faça commit a menos que eu peça. Não faça push. Não inicie a AP.05.
```
