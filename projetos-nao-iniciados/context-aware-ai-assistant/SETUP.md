# Configuração do Cursor — Context-Aware AI Assistant

## Prompt inicial recomendado

```text
Leia o ROADMAP.md, o README.md e todas as Project Rules.
Valide a CAA.01 contra o estado atual do repositório.
Se o Definition of Done estiver atendido, marque somente a CAA.01 como concluída.
Ajuste o README apenas se necessário.
Execute as validações.
Não faça commit a menos que eu peça. Não faça push. Não inicie a CAA.02.
```
