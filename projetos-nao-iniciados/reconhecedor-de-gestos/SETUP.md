# Configuração do Cursor — Reconhecedor de Gestos

## Prompt inicial recomendado

```text
Leia o ROADMAP.md, o README.md e todas as Project Rules.
Valide a RG.02 contra o estado atual do repositório.
Se o Definition of Done estiver atendido, marque somente a RG.02 como concluída.
Ajuste o README apenas se necessário.
Execute as validações.
Não faça commit a menos que eu peça. Não faça push. Não inicie a RG.03.
```
