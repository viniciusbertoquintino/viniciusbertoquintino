# Configuração do Cursor — Analista de Prevenção a Fraudes

## Prompt inicial recomendado

```text
Leia o ROADMAP.md, o README.md e todas as Project Rules.
Valide a PF.00 contra o estado atual do repositório.
Se o Definition of Done estiver atendido, marque somente a PF.00 como concluída.
Ajuste o README apenas se necessário.
Execute as validações.
Não faça commit a menos que eu peça. Não faça push. Não inicie a PF.01.
```
