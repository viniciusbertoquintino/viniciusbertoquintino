...
- pipeline RAG com embeddings e pgvector;
- agentes especializados (Document Analyst, Ticket Assistant, Workflow Planner);
- frontend React com dashboard, chat e upload;
- observabilidade (logs, tokens, latência);
- stack full-stack com Supabase e backend FastAPI opcional.
...
| Próxima etapa | AP.04 — auditar README vs código |
| Superfície | React + Supabase + FastAPI |
